...
public class RegForm implements ActionListener {
    ...
    RegForm(){
        ...
        String[] dept = { "Select Department","Arabic","Assamese","Bengali","Bodo","Communication & Journalism",
                        ...
                        "Anthropology","Botany","Chemistry","Environmental Science","Geography","Geological Sciences","Mathematics",
                        "Physics","Statistics","Zoology",
                    
                        "Biotechnology","Computer Science","Electronics & Communication Technology","Instrumentation and USIC",
        ...
        String[] subItems6 = {"Select Course","B.A. Economics","M.A. Economics","B.Sc. Economics","M.Sc. Economics" };
        subItems.put(dept[6], subItems6);
        String[] subItems7 = {"Select Course","B.A. Education ","M.A. Education","B.Sc. Education","M.Sc. Education" };
        ...
        String[] subItems15 = {"Select Course","B.A. Comparitive Indian Literature","M.A. Comparitive Indian Literature"  };
        ...
        String[] subItems19 = {"Select Course","B.A. Psychology","M.A. Psychology","B.Sc. Psychology","M.Sc. Psychology"  };
        ...
        String[] subItems23 = {"Select Course","B.A. Anthropology","M.A. Anthropology","B.Sc. Anthropology","M.Sc. Anthropology"  };
        subItems.put(dept[23], subItems23);
        String[] subItems24 = {"Select Course","B.Sc. Botany","M.Sc. Botany","B.Sc. Microbiology","M.Sc. Microbiology"  };
        ...
        String[] subItems27 = {"Select Course","B.A. Geography","M.A. Geography","B.Sc. Geography","M.Sc. Geography"  };
        subItems.put(dept[27], subItems27);
        String[] subItems28 = {"Select Course","B.Sc. Geology","M.Sc. Geology"  };
        subItems.put(dept[28], subItems28);
        String[] subItems29 = {"Select Course","B.A. Mathematics","M.A. Mathematics","B.Sc. Mathematics","M.Sc. Mathematics"  };
        ...
        String[] subItems32 = {"Select Course","B.Sc. Zoology","M.Sc. Zoology","B.Sc. Wildlife Science","M.Sc. Wildlife Science" };
        ...
        String[] subItems34 = {"Select Course","B.Sc. Computer Science","M.Sc. Computer Science","B.Sc. Information Technology","M.Sc. Information Technology"    };
        subItems.put(dept[34], subItems34);
        String[] subItems35 = {"Select Course","B.Sc. Electronics & Communication Technology","M.Sc. Electronics & Communication Technology",
        ...
        String[] subItems37 = {"Select Course","B.Tech Signal Pocessing and Communication","M.Tech. Signal Pocessing and Communicatio","B.Tech Signal Processing and VLSI","M.Tech. Signal Processing and VLSI"  };
        subItems.put(dept[37], subItems37);
        String[] subItems38 = {"Select Course","B.Tech Material Science and Technology","M.Tech. Material Science and Technology"  };
